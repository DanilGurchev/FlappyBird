...
# Загрузка ресурсов
bird_img = pygame.image.load("bird.png")  # Изображение птицы
pipe_img = pygame.image.load("pipe.png")  # Изображение трубы
pipe_img = pygame.transform.scale(pipe_img, (60, 400))  # Масштабирование трубы
background_img = pygame.image.load("background.png")  # Фон
